...
public class Shooting : MonoBehaviour
{
    ...
    public void AddAmmo()
    {
        int bulletsToReload = Mathf.Min(MaxMag, NowReserveMag);
        NowMaxMag += bulletsToReload;
        NowReserveMag -= bulletsToReload;
    }
     public void PickUpBullets(int bullets)
    {
        NowReserveMag = Mathf.Min(NowReserveMag + bullets, MaxReserveMag); возможный метод добавления пуль
    }
